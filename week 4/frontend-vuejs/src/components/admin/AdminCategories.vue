<template>
  <div class="admin-categories">
    ...
    <BaseDialog :is-open="showForm" :title="editing ? t('admin.actions.edit') : t('admin.actions.new')" @close="showForm = false">
      <form id="admin-category-form" class="dialog-form" novalidate @submit.prevent="submitForm">
      ...
      <template #footer>
        ...
        <BaseButton variant="primary" size="md" type="submit" form="admin-category-form" :loading="saving">
...
async function confirmedDeactivate() {
  ...
  try {
    ...
    deactivateError.value = messageFor(err)
  } finally {
    pendingId.value = null
  }
}
